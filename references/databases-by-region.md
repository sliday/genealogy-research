...
- [Belarus / Lithuania / Latvia](#belarus--lithuania--latvia)
- [Ukraine](#ukraine)
...
| WikiTree | wikitree.com | Collaborative single world tree | Free |
| Geni | geni.com | World family tree, collaborative | Free/subscription |

---

## Poland / former Russian Empire
...
| Service | URL | What it contains | Access |
|---------|-----|-----------------|--------|
| Archion | archion.de | Protestant (Evangelical) church books | Subscription |
...
**Tips for Germany:**
- Civil registration nationwide from 1876 (earlier in some regions)
- Church books go back to 1550s in some areas
- Surname spelling standardized only in 19th century — expect variations
- Many records destroyed in WWII — check what survives before searching
...
| Service | URL | What it contains | Access |
|---------|-----|-----------------|--------|
| OBD Memorial | obd-memorial.ru | WWII military losses | Free |
| Pamyat Naroda | pamyat-naroda.ru | WWII awards, combat path | Free |
| GARF | statearchive.ru | State Archive of Russian Federation | Visit/mail |
| RGIA | fgurgia.ru | Russian Historical Archive (pre-1917) | Visit/mail |
| VGD | vgd.ru | Forum + volunteer lookup database | Free |
| Rodovid | rodovid.org | Collaborative family tree wiki | Free |
| Podvignaroda | podvignaroda.ru | WWII feats and awards | Free |
...
| Service | URL | What it contains | Access |
|---------|-----|-----------------|--------|
| FreeBMD | freebmd.org.uk | English/Welsh civil registration index (1837+) | Free |
| FreeREG | freereg.org.uk | Parish register transcriptions | Free |
...
- Most departmental archives have digitized records online for free
- Naming: "dit" names (aliases), "de" particles, regional language variants
...
- Church records go back to 1500s (Council of Trent mandate)
- Records in Italian, Latin, or local dialect depending on period
...
| SSDI | familysearch.org | Social Security Death Index | Free |
| NARA | archives.gov | National Archives (censuses, military, naturalization) | Free/visit |

**Tips for USA:**
- Federal census every 10 years (1790–1950 public). 1890 census mostly destroyed by fire
- Immigration: passenger lists, naturalization records, alien registration
- State vital records: varies by state (some from 1600s, most from late 1800s)
...
| Service | URL | What it contains | Access |
|---------|-----|-----------------|--------|
| JRI-Poland | jri-poland.org | Jewish Records Indexing — Poland | Free |
| Yad Vashem | yadvashem.org | Holocaust victims database | Free |
| JewishGen | jewishgen.org | Jewish genealogy databases worldwide | Free (registration) |
| YIVO | yivo.org | Yiddish cultural/genealogical archives | Visit/mail |
| Gesher Galicia | geshergalicia.org | Galician Jewish records | Free/subscription |
...
|---------|-----|---------------|
| AncestryDNA | ancestry.com/dna | Largest database, ethnicity + matches |
| 23andMe | 23andme.com | Health + ancestry, smaller match DB |
| MyHeritage DNA | myheritage.com/dna | Good European coverage |
| FamilyTreeDNA | familytreedna.com | Y-DNA, mtDNA, autosomal |
| GEDmatch | gedmatch.com | Free comparison tool (upload from any service) |
| DNAPainter | dnapainter.com | Chromosome mapping tool |

**Tips:**
- Start with AncestryDNA (largest database) or MyHeritage (best for European roots)
- Upload raw DNA to GEDmatch for cross-platform matching
- Y-DNA traces paternal line; mtDNA traces maternal line; autosomal covers all ancestors (fades after ~6 generations)
